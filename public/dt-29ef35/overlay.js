...
<div class="wrap">
  ...
  function render() {
    ...
    S.getElementById("leftcol").classList.toggle("readtop", halfPos === "top");
  ...
  function renderSet() {
    ...
    $("tree").innerHTML =
      ...
      `h 반페이지 모드 &nbsp;·&nbsp; Shift+H 읽는 영역 위/아래<br>` +
      `본문 클릭 — 전체 가리기<br>` +
